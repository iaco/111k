...
#print "nombre=$nombre , apellido=$apellido, direccion=$direccion, fecha=$fecha_nacimiento\n";
#$servidor->agregar_persona($nombre,$apellido,$direccion,$fecha_nacimiento);
##<button type="button" onclick="index.pl">Volver</button>
